...
@Component({
  selector: 'app-edit-nature-business-dialog',
  templateUrl: './edit-nature-business-dialog.component.html',
  styleUrls: ['./edit-nature-business-dialog.component.scss']
})
export class EditNatureBusinessDialogComponent implements OnInit {

  updateNatureBizFormGroup: FormGroup;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<EditNatureBusinessDialogComponent>,
  ...
  ngOnInit() {
    ...
    this.updateNatureBizFormGroup = this.formBuilder.group({
      natureBiz: ["", Validators.required]
    });
  ...
  setClientData() {
    this.updateNatureBizFormGroup.patchValue({
      natureBiz: this.data.clientData.companyDetails.natureOfBusiness
    });
  }
  ...
  onUpdateBtnClicked() {
    this.updateCompany = {
      ...
      natureOfBusiness: this.updateNatureBizFormGroup.value.natureBiz,
    ...
    this.api.updateClientCompany(this.updateCompany).subscribe(res => {
      ...
      console.log("RESP: Update nature of business -> ", res);
      this.successSnackBar(res);
      // this.openSuccessDialog(res.message);
    }, err => {
      this.dialogRef.close();
      console.log("FAILED: Update nature of business -> ", err);
